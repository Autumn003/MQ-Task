    ...
    <div className=" px-5">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={cn(
            "flex max-w-xl justify-between mx-auto fixed top-10 inset-x-0 border border-transparent dark:border-white/20 rounded-full dark:bg-black/10 backdrop-blur-sm bg-white/10 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-5000 pr-2 pl-4 py-2  items-center space-x-4",
            className
          )}
        >
